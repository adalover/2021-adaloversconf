...
export const SPONSOR_TITLE = 'Colaboradores - ' + EVENT_NAME;
...
export const SPEAKERS_TITLE = 'Ponentes - ' + EVENT_NAME;
export const SPEAKERS_DESCRIPTION = 'Las ponentes con las que contaremos en esta edición on-line';
